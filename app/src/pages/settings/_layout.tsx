...
const SettingsLayout = () => {
  ...
  return (
    <Defaults>
      ...
      >
        <Container flexDirection="row" flexGrow={1} height="100%" maxHeight={768} maxWidth={1024} padding={12} width="100%">
          <Container display={sidebarDisplay} flexDirection="column" flexGrow={1} maxWidth={256}>
            { }
            <Button
